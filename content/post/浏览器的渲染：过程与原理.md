...
comment: true
draft: false
date: 2018-04-26T16:50:34+08:00
lastmod: 2018-04-26T16:50:34+08:00
categories: ["Front-End", "搬运整理"]
tags: ["浏览器", "渲染", "综合"]
author: '<a href="http://tianfangye.com/" rel="noopener" target="_blank">天方夜</a>'
weight: 10
contentCopyright: '<a href="http://tianfangye.com/2017/09/17/browser-rendering-processes-and-principles/" rel="noopener" target="_blank">See origin</a>'
---
...
从耗时的角度，浏览器请求、加载、渲染一个页面，时间花在下面[五件事情][01]上：
...
本文讨论第五个部分，即浏览器对内容的渲染，这一部分（渲染树构建、布局及绘制），又可以分为下面[五个步骤][02]：
...
浏览器的发展日益加快（目前的 Chrome 官方稳定版是 66），具体的渲染策略会不断进化，但了解这些原理后，就能想通它进化的逻辑。下面来看看 CSS 与 JavaScript 具体会怎样阻塞资源。
...
1. [Mobile Analysis in PageSpeed Insights][03]
2. [Web Fundamentals][04]
3. [MDN - HTML element reference][05]


[01]: https://developers.google.com/speed/docs/insights/mobile
[02]: https://developers.google.com/web/fundamentals/performance/critical-rendering-path/render-tree-construction
[03]: https://developers.google.com/speed/docs/insights/mobile
[04]: https://developers.google.com/web/fundamentals/
[05]: https://developer.mozilla.org/en-US/docs/Web/HTML/Element/script